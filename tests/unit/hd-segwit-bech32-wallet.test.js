...
describe('Bech32 Segwit HD (BIP84)', () => {
  ...
  it('can create with custom derivation path', async () => {
    ...
    hd.setDerivationPath("m/84'/597'/1'");
    ...
    assert.strictEqual(hd._getDerivationPathByAddress(hd._getExternalAddressByIndex(0)), "m/84'/597'/1'/0/0");
    assert.strictEqual(hd._getDerivationPathByAddress(hd._getInternalAddressByIndex(0)), "m/84'/597'/1'/1/0");
  });
